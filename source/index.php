...
<tr>
<td colspan="2">
<iframe SRC='tool.php?user=<?php echo $session?>' name="tool" scrolling='no' width='100%' height='50' marginwidth='0' marginheight='0' hspace='0' vspace='0' frameborder='0'>
</iframe>
</td>
</tr>
  <tr>
...
<td width="15%">
<iframe SRC='folders.php?user=<?php echo $session?>' name="list1" scrolling='no' width='100%' height='350' marginwidth='0' marginheight='0' hspace='0' vspace='0' frameborder='0'>
</iframe>
</td>

<td width="85%">
<div align='center'>
<iframe SRC='<?php echo $main_page?>' name="list2" scrolling='yes' width='100%' height='350' marginwidth='0' marginheight='0' hspace='0' vspace='0' frameborder='0'>
</iframe>
</div>
</td>
  ...
  <tr>
    <td>
	<iframe SRC='tool.php?user=<?php echo $session?>' name="tool" scrolling='no' width='100%' height='40' marginwidth='0' marginheight='0' hspace='0' vspace='0' frameborder='0'>
</iframe>
	</td>
  </tr>
  <tr>
    <td>
	<iframe SRC='<?php echo $main_page?>' name="list2" scrolling='no' width='100%' height='350' marginwidth='0' marginheight='0' hspace='0' vspace='0' frameborder='0'>
</iframe>
	</td>
  </tr>
</table>
